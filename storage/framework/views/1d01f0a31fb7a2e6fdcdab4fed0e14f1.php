...
<body style="background-image: url('<?php echo e(asset('assets/background.png')); ?>'); 
    ...
    <div class="login-container">
        <main class="login-card">
            <div class="logo-area">
                <img src="<?php echo e(asset('assets/ESIEA.png')); ?>" alt="Logo ESIEA" class="login-logo">
            </div>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="input-group">
                    ...
                    <input type="email" id="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="Votre adresse e-mail" required>
                </div>
...
</html><?php /**PATH /home/scotty/tp-web-3/tixpro-laravel/resources/views/auth/login.blade.php ENDPATH**/ ?>